...
This is a fork of the magiclabs fork [https://github.com/magiclabs/userstamp] of the original userstamp plugin created by delynn [https://github.com/delynn/userstamp].
...
To use this fork add the following to your application gemfile:
  ...
  gem "userstamp",  :require => 'userstamp', :git => 'https://github.com/konvenit/userstamp'
